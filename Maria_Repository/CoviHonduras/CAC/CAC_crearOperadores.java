...
public class CAC_crearOperadores extends _CAC_Settingsfields_ {
...
public void crearOperadores() throws Exception {
	...
	borrarArchivosTemp("E:\\workspace\\Maria_Repository\\Host_VerTranscciones\\attachments\\");
	try{
		driver.get(_CAC_Settingsfields_.CaCUrl);
		...
		System.out.print("Se ha Creado el "+lastcreated+" con la contraseaña: 00001"+ " en el grupo de "+operatorG.substring(04));
	}catch(Exception e){
		e.printStackTrace();
		fail();
	}
